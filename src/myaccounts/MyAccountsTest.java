...
public class MyAccountsTest extends Utility {
    String baseurl = " http://tutorialsninja.com/demo/index.php?";
        ...
        public void verifyThatUserRegisterAccountSuccessfully(){
            ...
            sendTextToElement(By.xpath("//input[@id='input-firstname']"), "Amruta");
            //3.4 Enter Last Name
            sendTextToElement(By.xpath("//input[@id='input-lastname']"), "Goswami");
            //3.5 Enter Email
            Random randomGenerator = new Random();
            int randomInt = randomGenerator.nextInt(1000);
            sendTextToElement(By.xpath("//input[@id='input-email']"), "Happy01"+ randomInt +"@gmail.com");
            //3.6 Enter Telephone
        ...
        public void verifyThatUserShouldLoginAndLogoutSuccessfully(){
            ...
            sendTextToElement(By.xpath("//input[@id='input-email']"), "happy01@gmail.com");
            //4.5 enter password
            sendTextToElement(By.xpath("//input[@id='input-password']"), "1234");
