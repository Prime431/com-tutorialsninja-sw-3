...
public class LaptopsAndNotebooksTest extends Utility {
    String baseurl = " http://tutorialsninja.com/demo/index.php?";
        ...
        public void verifyProductsPriceDisplayHighToLowSuccessfully(){
            ...
            selectByVisibleTextFromDropdown(By.xpath("//select[@id='input-sort']"),"4");
        ...
        public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
            ...
            sendTextToElement(By.xpath("//input[@id='input-payment-firstname']"),"Amruta");
            sendTextToElement(By.xpath("//input[@id='input-payment-lastname']"),"Goswami");
            sendTextToElement(By.xpath("//input[@id='input-payment-email']"),"Amruta_0250@yahoo.co.in");
            sendTextToElement(By.xpath("//input[@id='input-payment-telephone']"),"07427801010");
            sendTextToElement(By.xpath("//input[@id='input-payment-address-1']"),"195");
            sendTextToElement(By.xpath("//input[@id='input-payment-city']"),"london");
            sendTextToElement(By.xpath("//input[@id='input-payment-postcode']"),"Ha39tf");
