...
@Test
    ...
    List<WebElement> products = findElementsFromWebPage(By.xpath("//h4/a"));
    ...
    products = findElementsFromWebPage(By.xpath("//h4/a"));
    ...
    public void verifyProductAddedToShoppingCartSuccessFully(){
        ...
        while (true) {
            String monthAndYear = findElementFromWebPage(By.xpath("//div[@class = 'datepicker']/div[1]//th[@class='picker-switch']")).getText();
        ...
        List<WebElement> allDates = findElementsFromWebPage(By.xpath("//div[@class = 'datepicker']/div[1]//tbody/tr/td[@class = 'day']"));
